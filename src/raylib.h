...
RLAPI RenderTexture2D LoadRenderTextureEx(int width, int height, int colorBufferFormat, int depthBufferBits); // Load texture for rendering (framebuffer), with options
